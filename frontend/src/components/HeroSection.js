        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-2 sm:py-3">
            ...
            <div className="flex items-center space-x-3 sm:space-x-6 md:space-x-8">
              <a href="#features" className="hidden sm:inline text-xs sm:text-sm font-medium hover:opacity-80 transition-opacity" style={{ color: '#475569' }}>Features</a>
              <a href="#resources" className="hidden md:inline text-xs sm:text-sm font-medium hover:opacity-80 transition-opacity" style={{ color: '#475569' }}>Resources</a>
              <button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="group p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-2" style={{ background: 'rgba(255, 255, 255, 0.8)' }}>
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3" style={{ color: '#1E252B' }}>Sessions & Routines</h3>
              <p className="text-xs sm:text-sm font-light" style={{ color: '#475569' }}>Stay on track with guided sessions and personalized routines that adapt to your needs.</p>
            </div>
            ...
            <div className="group p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-2" style={{ background: 'rgba(255, 255, 255, 0.8)' }}>
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3" style={{ color: '#1E252B' }}>Personalized Activities</h3>
              <p className="text-xs sm:text-sm font-light" style={{ color: '#475569' }}>Reflections, exercises, and grounding techniques tailored to your mental wellness journey.</p>
            </div>
            ...
            <div className="group p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-2" style={{ background: 'rgba(255, 255, 255, 0.8)' }}>
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3" style={{ color: '#1E252B' }}>Mood Insights</h3>
              <p className="text-xs sm:text-sm font-light" style={{ color: '#475569' }}>Emoji-based mood graphs and insights to help you understand your emotional patterns.</p>
            </div>

            <div className="group p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-2" style={{ background: 'rgba(255, 255, 255, 0.8)' }}>
              <div  className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center mb-3 sm:mb-4 mx-auto" style={{ background: 'linear-gradient(135deg, #FFEBEE 0%, #FFCDD2 100%)' }}>
                <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" fill="none" stroke="#C62828" viewBox="0 0 24 24" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                </svg>
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3" style={{ color: '#1E252B' }}>Instant Help</h3>
              <p className="text-xs sm:text-sm font-light" style={{ color: '#475569' }}>Crisis button always within reach for immediate support when you need it most.</p>
            </div>
            ...
            <div className="group p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-2" style={{ background: 'rgba(255, 255, 255, 0.8)' }}>
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3 text-center" style={{ color: '#1E252B' }}>Powered by Gemini</h3>
              <p className="text-xs sm:text-sm font-light text-center" style={{ color: '#475569' }}>Gentle, smart support that adapts to you and provides compassionate AI-powered assistance.</p>
            </div>
            ...
            <div className="group p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl backdrop-blur-sm border border-white/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-2" style={{ background: 'rgba(255, 255, 255, 0.8)' }}>
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3" style={{ color: '#1E252B' }}>Privacy First</h3>
              <p className="text-xs sm:text-sm font-light" style={{ color: '#475569' }}>Your data is encrypted and secure. Your privacy and safety are our top priorities.</p>
            </div>
          </div>
        </div>
      </div>
