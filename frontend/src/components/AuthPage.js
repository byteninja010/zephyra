        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:-translate-y-1 animate-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm font-medium" style={{ color: '#475569' }}>
              {mode === 'login' ? 'Returning to your safe space' : 'Begin your mental wellness journey with us'}
            </p>
          </div>
          ...
          {mode === 'login' && (
            <div className="space-y-6 animate-fade-in">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold" style={{ color: '#1E252B' }}>Returning User</h3>
                  ...
                  >
                    {isLoading ? (
                      ...
                      <div className="flex items-center justify-center space-x-3">
                        <svg className="w-6 h-6 group-hover:animate-wiggle" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1721 9z" />
                        </svg>
          ...
          {mode === 'signup' && (
            <div className="space-y-6 animate-fade-in">
              <div className="space-y-4">
                <h3 className="text-lg font-semibold" style={{ color: '#1E252B' }}>New to Zephyra?</h3>
                ...
                <div className="p-4 rounded-xl border transform transition-all duration-300 hover:scale-[1.01] hover:shadow-md" style={{ background: 'rgba(60, 145, 197, 0.05)', borderColor: '#3C91C5' }}>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 mr-3 mt-0.5" style={{ color: '#3C91C5' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div>
                      <p className="text-sm font-medium mb-2" style={{ color: '#1E252B' }}>No Need to Worry - Your Account Will Be Anonymous</p>
                      <p className="text-xs" style={{ color: '#475569' }}>
                        We don't collect personal information. Your secret code is the only way to access your account. 
                        Keep it safe and private. Your mental health journey remains completely confidential.
                      </p>
                    </div>
                  </div>
                </div>
